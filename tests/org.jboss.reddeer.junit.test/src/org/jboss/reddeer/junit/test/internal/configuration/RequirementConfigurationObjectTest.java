...
import org.jboss.reddeer.junit.internal.configuration.RequirementConfigurationObject;
...
public class RequirementConfigurationObjectTest {
	...
	private RequirementConfigurationObject configuration;
	...
	public void readXML_nullEnclosingRequirementClass() {
		configuration = new RequirementConfigurationObject(Object.class, reader);
	}
	
	@Test(expected=ClassCastException.class)
	public void readXML_notRequirementClass() {
		configuration = new RequirementConfigurationObject(TestEnclosingClass.class, reader);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void readXML_notProperConfigurationRequirementClass() {
		configuration = new RequirementConfigurationObject(TestEnclosingClass.TestInnerClass.class, reader);
	}
	...
	public void readXML_customConfigurationClass() {
		...
		configuration = new RequirementConfigurationObject(TestCustomJavaRequirement.CustomJavaAnnotation.class, reader);
	...
	public void readXML_propertyConfigurationClass() {
		...
		configuration = new RequirementConfigurationObject(TestPropertyRequirementA.PropertyAnnotationA.class, reader);
